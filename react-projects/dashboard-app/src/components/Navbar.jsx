...
const Navbar = () => {
  ...
  // execute this every time something changes in the array param or only on start.
  useEffect(() => {
    const handleResize = () => setScreenSize(window.innerWidth);
    // every time screen size is changed, update the value
    window.addEventListener('resize', handleResize);
    
    handleResize();
    // need to remove that event listener. 
